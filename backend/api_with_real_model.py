...
import logging
from real_model_loader import model_loader
...
PRICE_DATA = {
    "somdej-fatherguay": {"min": 15000, "avg": 45000, "max": 150000},
    "พระพุทธเจ้าในวิหาร": {"min": 8000, "avg": 25000, "max": 80000},
    "พระสมเด็จฐานสิงห์": {"min": 12000, "avg": 35000, "max": 120000},
    "พระสมเด็จประทานพร พุทธกวัก": {"min": 10000, "avg": 30000, "max": 100000},
    "พระสมเด็จหลังรูปเหมือน": {"min": 18000, "avg": 55000, "max": 180000},
    "พระสรรค์": {"min": 5000, "avg": 18000, "max": 60000},
    "พระสิวลี": {"min": 3000, "avg": 12000, "max": 40000},
    "สมเด็จพิมพ์ปรกโพธิ์ 9 ใบ": {"min": 25000, "avg": 75000, "max": 250000},
    "สมเด็จแหวกม่าน": {"min": 20000, "avg": 60000, "max": 200000},
    "ออกวัดหนองอีดุก": {"min": 8000, "avg": 22000, "max": 70000},
}
...
def generate_recommendations(class_name: str, price_range: dict):
    ...
    if "สมเด็จ" in class_name or "somdej" in class_name.lower():
        recommendations = [
            {
