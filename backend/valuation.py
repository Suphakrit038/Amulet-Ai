...
try:
    from .config import price_config, get_config
except ImportError:
    ...
    class EnhancedPriceConfig:
        ...
        base_prices = {
            "หลวงพ่อกวยแหวกม่าน": {"low": 15000, "mid": 45000, "high": 120000, "ultra_rare": 300000},
            "โพธิ์ฐานบัว": {"low": 8000, "mid": 25000, "high": 75000, "ultra_rare": 180000},
            "ฐานสิงห์": {"low": 12000, "mid": 35000, "high": 85000, "ultra_rare": 220000},
            "สีวลี": {"low": 5000, "mid": 18000, "high": 50000, "ultra_rare": 120000},
            "พระสมเด็จ": {"low": 20000, "mid": 60000, "high": 150000, "ultra_rare": 400000},
            "พระพิมพ์ปรก": {"low": 10000, "mid": 30000, "high": 80000, "ultra_rare": 200000},
            "พระนาคปรก": {"low": 7000, "mid": 22000, "high": 65000, "ultra_rare": 160000}
        }
    ...
    def _initialize_market_intelligence(self):
        ...
        try:
            ...
            self.historical_trends = {
                "หลวงพ่อกวยแหวกม่าน": {"trend": "trending_up", "volatility": 0.3, "demand": "high"},
                "โพธิ์ฐานบัว": {"trend": "stable", "volatility": 0.2, "demand": "medium"},
                "ฐานสิงห์": {"trend": "trending_up", "volatility": 0.4, "demand": "high"},
                "สีวลี": {"trend": "stable", "volatility": 0.15, "demand": "medium"},
                "พระสมเด็จ": {"trend": "trending_up", "volatility": 0.5, "demand": "very_high"},
                "พระพิมพ์ปรก": {"trend": "stable", "volatility": 0.25, "demand": "medium"},
                "พระนาคปรก": {"trend": "trending_down", "volatility": 0.2, "demand": "low"}
            }
